...
namespace Recognition
{
    ...
    class Program
    {
        ...
        {
            //string expression = "3*tan(x/7+9)+7*(3*78*x^3+69*(2*cos(2*x+8)+3*sin(x))^2)";
            //string expression = "sin(x)*3*x*2*x*((x-7)+6*sin(x/76))";
            //string expression = "(2*(6*6/sin(x)-76.365445)+(x+7^2))*(x^9-4)";
            //int[] position = getBlockLR("multiply(multiply(sin(x),3),x)*(2*x*((x-7)+6*sin(x/76)))", "*");
            //string expression = "multiply(multiply(multiply(sin(x),3),x),(multiply(multiply(2,x),(minus((minus(x,7)),multiply(6,sin(divide(x,76))))))))";
            //string expression = "2*(3*78*x+69*(2*cos(x)))+69*x^2+log((2*x+8),76)";
            //Monomial m = new Monomial(expression);
            //Console.WriteLine(expression);
            //Console.WriteLine("x=-0.1");
            //Console.WriteLine(m.calc(-0.1));
            //Console.WriteLine("x=-0.2");
            //Console.WriteLine(m.calc(-0.2));
        }
